...
st.set_page_config(
    page_title='Xcel Data Analytics',
    page_icon='📊'
)

st.title(':green[KU FINAL PROJECT]')
st.subheader(':blue[Data Analystics(DAT)]')
st.subheader(':gray[Explore Data with ease.]')
st.divider()
...
if file:  # File is uploaded
    ...
    st.subheader(':blue[Column Values To Count]', divider='grey')
    ...
    st.subheader(':blue[Groupby : Simplify your data analysis]', divider='grey')
    ...
    st.warning(':red[Please upload a file to begin]')
